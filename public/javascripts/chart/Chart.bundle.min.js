...
!function (t) {
    ...
    return function t(e, n, i) {
        ...
        1: [function (t, e, n) {
            function i(t) {
                if (t) {
                    var e = /^#([a-fA-F0-9]{3})$/i, n = /^#([a-fA-F0-9]{6})$/i, i = /^rgba?\(\s*([+-]?\d+)\s*,\s*([+-]?\d+)\s*,\s*([+-]?\d+)\s*(?:,\s*([+-]?[\d\.]+)\s*)?\)$/i, a = /^rgba?\(\s*([+-]?[\d\.]+)\%\s*,\s*([+-]?[\d\.]+)\%\s*,\s*([+-]?[\d\.]+)\%\s*(?:,\s*([+-]?[\d\.]+)\s*)?\)$/i, r = /(\w+)/, o = [0, 0, 0], s = 1, l = t.match(e);
                    if (l) {
                        l = l[1];
            ...
            r.prototype = {
                isValid: function () {
                    ...
                    var n = this, i = t, a = void 0 === e ? .5 : e, r = 2 * a - 1, o = n.alpha() - i.alpha(), s = ((r * o == -1 ? r : (r + o) / (1 + r * o)) + 1) / 2, l = 1 - s;
            ...
            !function (t, i) {
                ...
                function Vt(t) {
                    var e = A(t), n = e.year || 0, i = e.quarter || 0, a = e.month || 0, r = e.week || 0, o = e.day || 0, s = e.hour || 0, l = e.minute || 0, u = e.second || 0, d = e.millisecond || 0;
                ...
                function ye(t, e, n) {
                    var i = Xt(t).abs(), a = bi(i.as("s")), r = bi(i.as("m")), o = bi(i.as("h")), s = bi(i.as("d")), l = bi(i.as("M")), u = bi(i.as("y")), d = a <= xi.ss && ["s", a] || a < xi.s && ["ss", a] || r <= 1 && ["m"] || r < xi.m && ["mm", r] || o <= 1 && ["h"] || o < xi.h && ["hh", o] || s <= 1 && ["d"] || s < xi.d && ["dd", s] || l <= 1 && ["M"] || l < xi.M && ["MM", l] || u <= 1 && ["y"] || ["yy", u];
                ...
                var De, Ce, Pe = De = Object.keys ? Object.keys : function (t) {
                    ...
                    y: "a year",
                    yy: "%d years"
                }, Fe = {}, Re = {}, Le = /(\[[^\[]*\])|(\\)?([Hh]mm(ss)?|Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|Qo?|YYYYYY|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|kk?|mm?|ss?|S{1,9}|x|X|zz?|ZZ?|.)/g, We = /(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g, Ye = {}, Ne = {}, ze = /\d/, Be = /\d\d/, Ve = /\d{3}/, He = /\d{4}/, Ee = /[+-]?\d{6}/, je = /\d\d?/, Ue = /\d\d\d\d?/, qe = /\d\d\d\d\d\d?/, Ge = /\d{1,3}/, Ze = /\d{1,4}/, Xe = /[+-]?\d{1,6}/, Je = /\d+/, Ke = /[+-]?\d+/, Qe = /Z|[+-]\d\d:?\d\d/gi, $e = /Z|[+-]\d\d(?::?\d\d)?/gi, tn = /[+-]?\d+(\.\d{1,3})?/, en = /[0-9]*['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+|[\u0600-\u06FF\/]+(\s*?[\u0600-\u06FF]+){1,2}/i, nn = {}, an = {}, rn = 0, on = 1, sn = 2, ln = 3, un = 4, dn = 5, cn = 6, hn = 7, fn = 8, gn = Ce = Array.prototype.indexOf ? Array.prototype.indexOf : function (t) {
                    var e;
                ...
                var mn = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/, pn = "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), vn = "Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec".split("_"), yn = en, bn = en;
                N("Y", 0, 0, function () {
                    var t = this.year();
                    return t <= 9999 ? "" + t : "+" + t
                }), N(0, ["YY", 2], 0, function () {
                ...
                var kn = "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), wn = "Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_"), Mn = "Su_Mo_Tu_We_Th_Fr_Sa".split("_"), Sn = en, Dn = en, Cn = en;
                ...
                var Un = /^(\-)?(?:(\d*)[. ])?(\d+)\:(\d+)(?:\:(\d+)(\.\d*)?)?$/, qn = /^(-)?P(?:(-?[0-9,.]*)Y)?(?:(-?[0-9,.]*)M)?(?:(-?[0-9,.]*)W)?(?:(-?[0-9,.]*)D)?(?:T(?:(-?[0-9,.]*)H)?(?:(-?[0-9,.]*)M)?(?:(-?[0-9,.]*)S)?)?$/;
                ...
                var ii = Math.abs, ai = me("ms"), ri = me("s"), oi = me("m"), si = me("h"), li = me("d"), ui = me("w"), di = me("M"), ci = me("y"), hi = pe("milliseconds"), fi = pe("seconds"), gi = pe("minutes"), mi = pe("hours"), pi = pe("days"), vi = pe("months"), yi = pe("years"), bi = Math.round, xi = {
                    ss: 44,
                    s: 45,
                    m: 45,
                    h: 22,
            ...
            i._set("bar", {
                ...
                t.controllers.bar = t.DatasetController.extend({
                    dataElementType: a.Rectangle, initialize: function () {
                        ...
                        var i = this, a = i.chart, o = i.getMeta(), s = i.getDataset(), l = t.custom || {}, u = a.options.elements.rectangle;
                        ...
                        var e = this.chart.data.datasets[t._datasetIndex], n = t._index, i = t.custom || {}, a = t._model, o = this.chart.options.elements.rectangle;
            ...
            i._set("bubble", {
                ...
                t.controllers.bubble = t.DatasetController.extend({
                    dataElementType: a.Point, update: function (t) {
                        ...
                        var i = this, a = i.getMeta(), r = t.custom || {}, o = i.getScaleForId(a.xAxisID), s = i.getScaleForId(a.yAxisID), l = i._resolveElementOptions(t, e), u = i.getDataset().data[e], d = i.index, c = n ? o.getPixelForDecimal(.5) : o.getPixelForValue("object" == typeof u ? u : NaN, e, d), h = n ? s.getBasePixel() : s.getPixelForValue(u, e, d);
                        ...
                        var n, i, a, o = this, s = o.chart, l = s.data.datasets[o.index], u = t.custom || {}, d = s.options.elements.point, c = r.options.resolve, h = l.data[e], f = {}, g = {
                            chart: s,
                            dataIndex: e,
                            dataset: l,
                    ...
                    labels: {
                        generateLabels: function (t) {
                            ...
                            return e.labels.length && e.datasets.length ? e.labels.map(function (n, i) {
                                var a = t.getDatasetMeta(0), o = e.datasets[0], s = a.data[i], l = s && s.custom || {}, u = r.valueAtIndexOrDefault, d = t.options.elements.arc;
                                return {
                                    text: n,
                    ...
                    update: function (t) {
                        ...
                        if (f < 2 * Math.PI) {
                            var g = a.rotation % (2 * Math.PI), m = (g += 2 * Math.PI * (g >= Math.PI ? -1 : g < -Math.PI ? 1 : 0)) + f, p = {
                                ...
                                x: Math.cos(m),
                                y: Math.sin(m)
                            }, y = g <= 0 && m >= 0 || g <= 2 * Math.PI && 2 * Math.PI <= m, b = g <= .5 * Math.PI && .5 * Math.PI <= m || g <= 2.5 * Math.PI && 2.5 * Math.PI <= m, x = g <= -Math.PI && -Math.PI <= m || g <= Math.PI && Math.PI <= m, _ = g <= .5 * -Math.PI && .5 * -Math.PI <= m || g <= 1.5 * Math.PI && 1.5 * Math.PI <= m, k = h / 100, w = {
            ...
            i._set("line", {
                ...
                t.controllers.line = t.DatasetController.extend({
                    ...
                    updateElement: function (t, e, n) {
                        var i, a, o = this, s = o.getMeta(), l = t.custom || {}, u = o.getDataset(), d = o.index, c = u.data[e], h = o.getScaleForId(s.yAxisID), f = o.getScaleForId(s.xAxisID), g = o.chart.options.elements.point;
                    ...
                    removeHoverStyle: function (t) {
                        var e = this, n = e.chart.data.datasets[t._datasetIndex], i = t._index, a = t.custom || {}, o = t._model;
                ...
                legend: {
                    labels: {
                        generateLabels: function (t) {
                            var e = t.data;
                            return e.labels.length && e.datasets.length ? e.labels.map(function (n, i) {
                                var a = t.getDatasetMeta(0), o = e.datasets[0], s = a.data[i].custom || {}, l = r.valueAtIndexOrDefault, u = t.options.elements.arc;
                                return {
                                    text: n,
            ...
            i._set("radar", {scale: {type: "radialLinear"}, elements: {line: {tension: 0}}}), e.exports = function (t) {
                t.controllers.radar = t.DatasetController.extend({
                    ...
                    linkScales: r.noop,
                    update: function (t) {
                        var e = this, n = e.getMeta(), i = n.dataset, a = n.data, o = i.custom || {}, s = e.getDataset(), l = e.chart.options.elements.line, u = e.chart.scale;
                    ...
                    updateElement: function (t, e, n) {
                        var i = this, a = t.custom || {}, o = i.getDataset(), s = i.chart.scale, l = i.chart.options.elements.point, u = s.getPointPositionForValue(e, o.data[e]);
                    ...
                    removeHoverStyle: function (t) {
                        var e = this.chart.data.datasets[t._datasetIndex], n = t.custom || {}, i = t._index, a = t._model, o = this.chart.options.elements.point;
            ...
            e.exports = function (t) {
                ...
                t.DatasetController = function (t, e) {
                    ...
                    removeHoverStyle: function (t, e) {
                        var n = this.chart.data.datasets[t._datasetIndex], a = t._index, r = t.custom || {}, o = i.valueAtIndexOrDefault, s = t._model;
                    ...
                    setHoverStyle: function (t) {
                        var e = this.chart.data.datasets[t._datasetIndex], n = t._index, a = t.custom || {}, r = i.valueAtIndexOrDefault, o = i.getHoverColor, s = t._model;
            ...
            e.exports = function (t) {
                ...
                t.layoutService = {
                    defaults: {}, addBox: function (t, e) {
                        ...
                        if (t) {
                            var l = t.options.layout || {}, u = i.options.toPadding(l.padding), d = u.left, c = u.right, h = u.top, f = u.bottom, g = e(t.boxes, "left"), m = e(t.boxes, "right"), p = e(t.boxes, "top"), v = e(t.boxes, "bottom"), y = e(t.boxes, "chartArea");
            ...
            r._set("scale", {
                ...
                t.Scale = o.extend({
                    ...
                    fit: function () {
                        ...
                        if (u.display && h) {
                            var v = s.longestText(t.ctx, g.font, r, t.longestTextCache), y = s.numberOfLabelLines(r), b = .5 * g.size, x = t.options.ticks.padding;
                            if (f) {
                    ...
                    draw: function (t) {
                        ...
                        if (i.display) {
                            var o = e.ctx, u = r.global, d = i.ticks.minor, c = i.ticks.major || d, h = i.gridLines, f = i.scaleLabel, g = 0 !== e.labelRotation, m = e.isHorizontal(), p = d.autoSkip ? e._autoSkip(e.getTicks()) : e.getTicks(), v = s.valueOrDefault(d.fontColor, u.defaultFontColor), y = n(d), b = s.valueOrDefault(c.fontColor, u.defaultFontColor), x = n(c), _ = h.drawTicks ? h.tickMarkLength : 0, k = s.valueOrDefault(f.fontColor, u.defaultFontColor), w = n(f), M = s.options.toPadding(f.padding), S = s.toRadians(e.labelRotation), D = [], C = "right" === i.position ? e.left : e.right - _, P = "right" === i.position ? e.left + _ : e.right, T = "bottom" === i.position ? e.top : e.bottom - _, I = "bottom" === i.position ? e.top + _ : e.bottom;
                ...
                t.Tooltip = a.extend({
                    initialize: function () {
                        ...
                        var n, i, a = this, c = a._options, h = a._model, f = a._model = s(c), g = a._active, m = a._data, p = {
                            xAlign: h.xAlign,
                            yAlign: h.yAlign
                        }, v = {x: h.x, y: h.y}, y = {width: h.width, height: h.height}, b = {x: h.caretX, y: h.caretY};
                        if (g.length) {
                            f.opacity = 1;
                            var x = [], _ = [];
            ...
            var p = t(45), v = "$chartjs", y = "chartjs-", b = y + "render-monitor", x = y + "render-animation", _ = ["animationstart", "webkitAnimationStart"], k = {
                ...
                return t.Legend = a.extend({
                    initialize: function (t) {
                        ...
                        if (n.display) {
                            ...
                            d = k ? {x: t.left + (l - u[0]) / 2, y: t.top + a.padding, line: 0} : {
                                x: t.left + a.padding,
                                y: t.top + a.padding,
                                line: 0
                            };
                    ...
                    determineDataLimits: function () {
                        ...
                        if (void 0 === s && a.each(r, function (e, n) {
                            ...
                            a.each(r, function (r, o) {
                                var s = i.getDatasetMeta(o), u = [s.type, void 0 === n.stacked && void 0 === s.stack ? o : "", s.stack].join(".");
                    ...
                    determineDataLimits: function () {
                        ...
                        if (void 0 === u && i.each(o, function (e, n) {
                            ...
                            i.each(o, function (a, o) {
                                var s = r.getDatasetMeta(o), l = [s.type, void 0 === n.stacked && void 0 === s.stack ? o : "", s.stack].join(".");
            ...
            function f(t, e, n, i, a, r) {
                var o, s = r.time, l = y.valueOrDefault(s.stepSize, s.unitStepSize), u = "week" === n && s.isoWeekday, c = r.ticks.major.enabled, h = _[n], f = p(t), g = p(e), m = [];
            ...
            var v = t(25), y = t(45), b = Number.MIN_SAFE_INTEGER || -9007199254740991, x = Number.MAX_SAFE_INTEGER || 9007199254740991, _ = {
                millisecond: {
                    major: !0,
                    size: 1,
            ...
            e.exports = function (t) {
                var e = {
                    ...
                    initialize: function () {
                        ...
                        var t, e, n, r, o, s, l = this, d = l.chart, c = l.options.time, h = u(c.min, l) || x, f = u(c.max, l) || b, g = [], m = [], v = [];
                        ...
                        var t, e, n, i = this, a = i.min, o = i.max, s = i.options, l = s.time, d = l.displayFormats, p = i.getLabelCapacity(a), v = l.unit || c(l.minUnit, a, o, p), y = h(v), b = [], x = [];
                        ...
                        var i = this, a = i.options, r = t.valueOf(), o = i._majorUnit, s = i._majorFormat, l = t.clone().startOf(i._majorUnit).valueOf(), u = a.ticks.major, d = u.enabled && o && s && r === l, c = t.format(d ? s : i._minorFormat), h = d ? u : a.ticks.minor, f = y.valueOrDefault(h.callback, h.userCallback);
                        return f ? f(c, e, n) : c
                        ...
                        var e = this, n = e.options.ticks, i = e.ctx.measureText(t).width, a = y.toRadians(n.maxRotation), r = Math.cos(a), o = Math.sin(a);
                        ...
                        var n = e.tickFormatFunction(p(t), 0, []), i = e.getLabelWidth(n), a = e.isHorizontal() ? e.width : e.height;
